...
class DataBase {
    constructor() {
        ...
        this._cadenaConexion = 'mongodb+srv://MoiDAM:abcdef.2@prueba00.9qv0c.mongodb.net/AtlasDAMDB?retryWrites=true&w=majority';
        this.conectarBD = () => __awaiter(this, void 0, void 0, function* () {
            const promise = new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                yield mongoose_1.default.connect(this._cadenaConexion, {
                    ...
                    .catch((error) => reject(`Error, el mensaje, conectando a ${this._cadenaConexion}: ${error}`));
            }));
            return promise;
        });
